              ...
              >
                ...
                <div className="p-7 flex-1 flex flex-col">
                  ...
                  <div className="mt-auto pt-5 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between">
                     ...
                     <Link to={`/project/${project.id}`} className="flex items-center gap-2 text-xs font-bold text-slate-700 dark:text-slate-300 bg-slate-100 dark:bg-slate-800 px-5 py-2.5 rounded-xl hover:bg-primary-600 hover:text-white dark:hover:text-white transition-all">
                        عرض <Eye size={14} />
                     </Link>
                  </div>
                </div>
