...
const Dashboard: React.FC<DashboardProps> = ({ user }) => {
   ...
   const quickActions = [
      ...
      { icon: <Activity size={18} />, label: 'الإحصائيات', link: '/dashboard/stats', color: 'bg-blue-800' },
   ];
                  ...
                  <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] border border-slate-200 dark:border-slate-800 shadow-lg overflow-hidden animate-fade-in-up delay-200">
                     ...
                     {userProjects.length > 4 && (
                        <div className="p-6 pt-0">
                           <Link to="/dashboard/my-projects" className="w-full py-4 rounded-2xl bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 font-bold text-sm hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors flex items-center justify-center gap-2">
                  ...
                  <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] p-8 border border-slate-200 dark:border-slate-800 shadow-lg animate-fade-in-up delay-200">
                     ...
                     <div className="space-y-4">
                        {notifications.map((notif) => (
                           <div
                              key={notif.id}
                              className={`p-4 rounded-2xl border transition-all hover:scale-[1.02] cursor-pointer ${notif.type === 'success' ? 'bg-green-50 dark:bg-green-900/10 border-green-200 dark:border-green-900/30' :
                           ...
                           >
                              <div className="flex gap-3">
                                 <div className={`w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 ${notif.type === 'success' ? 'bg-green-500 text-white' :
